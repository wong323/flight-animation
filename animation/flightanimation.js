// From http://www.tnoda.com/blog/2014-04-02
var width = 940;
var height = 620;
...
queue.defer(d3.json, "/json/countries.topo.json")
     .defer(d3.json, "/json/edited_airports.topo.json")
     .defer(d3.json, 'json/list_flight_OD.json')
     .await(loaded);
...
function loaded(error, countries, airports, od_pairs) {
  if (error) {
